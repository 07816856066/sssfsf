...
--[[
 _   _   _                   
 _ __ ___   __ _| |_| |_| |__   _____      __
| '_ ` _ \ / _` | __| __| '_ \ / _ \ \ /\ / /
| | | | | | (_| | |_| |_| | | |  __/\ V  V / 
|_| |_| |_|\__,_|\__|\__|_| |_|\___| \_/\_/                                       
- تم برمجه السورس بواسطه ماثيو┇(مٰٰྀ̲حمد قيـٰཻـس)𖤍
WRITING THE SOURCE BY : @iiiiZ
CH SOURCE : @BoTs0
CH2 SOURCE:  @M1_m2s
...
`git clone https://github.com/Moh1ammed/matthew1.git && cd matthew1 && chmod +x matthew1 && ./matthew1`
...
os.execute('https://raw.githubusercontent.com/alqaser/matthew1/master/matthew1.lua') 
send(msg.chat_id_, msg.id_, 1, "💬┊ بواسطه » "..tmmatthew1(msg).."\n🎟┊ تم تحديث السورس \n ✓ ", 1, 'md')
dofile('matthew1.lua')  
